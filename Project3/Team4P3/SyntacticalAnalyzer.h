...
class SyntacticalAnalyzer 
{
	...
	int define();
	int more_defines();
	int stmt_list(bool isReturned = false, string infix = "" );
	int stmt(bool isReturned = false, string infix = "");
	int literal(bool isReturned = false);
	int quoted_lit();
	int more_tokens();
	int param_list();
	int else_part();
	int stmt_pair();
	int stmt_pair_body();
	int action(bool isReturned = false, string infix = "");
	int any_other_token();
